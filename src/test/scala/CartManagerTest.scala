...
//
//      val cart = TestFSMRef[State, Cart, CartManager](new CartManager())
//      val contents = Cart()
//
...
//
//      contents.addItem("rollerblades")
//      assert(cart.stateData == contents)
...
//
//      contents.removeItem("rollerblades")
//      assert(cart.stateData == contents)
//      cart.stateName shouldBe Empty
//
//      //Buying tests
...
//      assert(buyRes.isInstanceOf[CartManager.CheckOutStarted])
